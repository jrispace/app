...
<!-- Mirrored from jritech.8b.io/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Apr 2020 21:22:54 GMT -->
...
<head>
  ...
  <meta name="description" content="SEO friendly and responsive website design, free and paid web hosting, digital marketing are the services that we provide to our customers. Get your business online starting for free.">
  <!-- Google Tag Manager -->
...
<!-- End Google Tag Manager -->
  ...
  window.smartlook||(function(d) {
    ...
    smartlook('init', '4679d4a94b056b1711d28483ad250a73647c4179');
</script>

  <title>JRiSpace Virtual Solutions</title>
  
  <script> (function(){ window.ldfdr = window.ldfdr || {}; (function(d, s, ss, fs){ fs = d.getElementsByTagName(s)[0]; function ce(src){ var cs = d.createElement(s); cs.src = src; setTimeout(function(){fs.parentNode.insertBefore(cs,fs)}, 1); } ce(ss); })(document, 'script', 'https://sc.lfeeder.com/lftracker_v1_lYNOR8xWxyQaWQJZ.js'); })(); </script>
    ...
    <div class="container-fluid">
        <div class="mbr-row align-center mbr-jc-c">
            <div class="title-block mbr-col-sm-12 mbr-col-md-12 mbr-col-lg-12">
                <h1 class="mbr-section-title mbr-fonts-style mbr-bold display-1">Welcome to<br>JRiSpace Virtual Solutions</h1>
                <h2 class="mbr-section-subtitle mbr-fonts-style mbr-pt-3 display-5">Website Design and Marketing company.<br></h2>
                
                <div class="mbr-section-btn mbr-pt-4"><a class="btn btn-warning display-7" href="/plans">See Plans</a> <a class="btn btn-white-outline display-7" href="https://jrispace.net/Apps" target="_blank">Get free site</a></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="mbr-row mbr-pt-4">
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 align-center md-pb">
                <div class="card-wrapper mbr-flex mbr-column">
                    ...
                    <div class="card-box">
                        <h3 class="card-title mbr-bold mbr-fonts-style display-5">Privacy Matters</h3>
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 align-center md-pb">
                <div class="card-wrapper mbr-flex mbr-column">
                    ...
                    <div class="card-box">
                        <h3 class="card-title mbr-bold mbr-fonts-style display-5">Experience</h3>
                        
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">
                            We worked with many companies to help them handle marketing and manage their human <br>resources.
                        </p>
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 align-center">
                <div class="card-wrapper mbr-flex mbr-column">
                    ...
                    <div class="card-box">
                        <h3 class="card-title mbr-bold mbr-fonts-style display-5">Various Term Lengths</h3>
                        
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">You can set the needed terms of cooperation, limit our partnership term lengths, select needed services.</p>
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 align-center last-child">
                <div class="card-wrapper mbr-flex mbr-column">
                    <div class="card-img align-center mbr-pb-3">
                        <div class="iconfont-wrapper">
                            <span class="amp-iconfont fa-coffee fa"><svg width="100%" height="100%" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path d="M1728 640q0-80-56-136t-136-56h-64v384h64q80 0 136-56t56-136zm-1664 768h1792q0 106-75 181t-181 75h-1280q-106 0-181-75t-75-181zm1856-768q0 159-112.5 271.5t-271.5 112.5h-64v32q0 92-66 158t-158 66h-704q-92 0-158-66t-66-158v-736q0-26 19-45t45-19h1152q159 0 271.5 112.5t112.5 271.5z"></path></svg></span>
                        </div>
                    </div>
                    <div class="card-box">
                        <h3 class="card-title mbr-bold mbr-fonts-style display-5">
                            Convenience
                        </h3>
                        
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">
                            Our specialists will do everything to make communication credible and effective. We work the way you prefere.</p>
...
<section class="youtube1 cid-rp8kpLvl9F" id="video1-22">

    

    <div class="mbr-jc-c container">
        <div class="title-block mbr-col-sm-12 mbr-col-md-12 mbr-m-auto mbr-px-4 mbr-pb-4 align-center">
            <h2 class="mbr-section-title mbr-fonts-style mbr-black mbr-pb-2 display-1">JRiSpace Web design</h2>
            <h3 class="mbr-section-subtitle mbr-fonts-style mbr-black display-5">We design your dream and we make to world better just for you!</h3>
        </div>
        <div class="video-block mbr-m-auto mbr-col-md-7"><amp-youtube width="16" height="9" layout="responsive" data-videoid="50pB5z2vIZ0" class="placeholder-loader"></amp-youtube>
            
        </div>
        </div>
</section>

<section class="header2 cid-rIr5YRr2b8" id="header2-3p">
        ...
        <div class="mbr-row mbr-black mbr-row-reverse">
            <div class="title-wrap mbr-col-md-12 mbr-col-sm-12 mbr-col-lg-6 align-left mbr-flex">
                <div class="title-block mbr-col-sm-12 mbr-col-md-12">
                    <h1 class="mbr-section-title mbr-fonts-style mbr-bold mbr-white display-1">Build your site today</h1>
                    
                    <p class="mbr-text mbr-fonts-style mbr-white mbr-pt-2 display-7">We are a Design and Marketing company. We design your dream and we make the world better just for you!&nbsp;<br></p>
                    <div class="mbr-section-btn mbr-pt-4"><a class="btn btn-white-outline display-7" href="https://jrispace.net/Apps" target="_blank">Learn How</a></div>
                </div>
            </div>
            <div class="image-wrap mbr-col-md-12 mbr-col-sm-12 mbr-col-lg-6 mbr-flex">
                <div class="image-block mbr-col-md-12 mbr-col-sm-12 mbr-mr-auto">
                    <amp-img src="https://r.8b.io/26178/images/face1-h_k3itssbj.jpg" layout="responsive" width="588.4815436241611" height="385" alt="" class="placeholder-loader">
                        <div placeholder="" class="placeholder">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
                                    <circle class="big" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="230" stroke-dashoffset="230" cx="150" cy="150" r="145"></circle>
                                    <circle class="small" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="212" cx="150" cy="150" r="135"></circle>
...
<section class="features3 cid-r0O1Uh7ayo" id="features3-3">
    

    
    <div class="container">
        <div class="title align-center">
            <h3 class="mbr-section-title mbr-bold mbr-fonts-style display-5">
                Selected one of the job opportunities below</h3>
        ...
        <div class="mbr-row mbr-pt-4 mbr-jc-c">
            <div class="card mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-4 md-pb">
                <div class="card-wrapper mbr-column">
                    <div class="card-img mbr-flex mbr-pb-3">
                        <amp-img src="https://r.8b.io/26178/images/TP32Affiliate32Program-h_k04c3r1e-454x300.jpg" layout="responsive" width="346.55333333333334" height="229" alt="" class="placeholder-loader">
                            <div placeholder="" class="placeholder">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
                                    <circle class="big" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="230" stroke-dashoffset="230" cx="150" cy="150" r="145"></circle>
                                    <circle class="small" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="212" cx="150" cy="150" r="135"></circle>
                                </svg></div>
                            <a href="http://pascaltrans.com/"></a>
                        </amp-img>
                    </div>
                    <div class="card-box mbr-m-auto align-center mbr-pt-3 mbr-px-4 mbr-pb-3">
                        <h3 class="card-title mbr-bold mbr-fonts-style display-5">Transporte Pascal Affiliate</h3>
                        <h4 class="card-subtitle mbr-pt-3 mbr-fonts-style mbr-bold display-7">Servicio de transporte internacional</h4>
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">Earn 9.5% for every client you send us.</p>
                        <div class="card-btn mbr-section-btn mbr-pt-2"><a class="btn btn-success-outline display-7" href="http://pascaltrans.com/affiliate/?ref=5" target="_blank">Apply Now</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-4 md-pb">
                <div class="card-wrapper mbr-column">
                    <div class="card-img mbr-flex mbr-pb-3">
                        <amp-img src="https://r.8b.io/26178/images/JRiTech32Logo-h_k04beozy-910x607.png" layout="responsive" width="346.30971993410213" height="231" alt="" class="placeholder-loader">
                            <div placeholder="" class="placeholder">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
                                    <circle class="big" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="230" stroke-dashoffset="230" cx="150" cy="150" r="145"></circle>
                                    <circle class="small" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="212" cx="150" cy="150" r="135"></circle>
                    ...
                    <div class="card-box mbr-m-auto align-center mbr-pt-3 mbr-px-4 mbr-pb-3">
                        <h3 class="card-title mbr-bold mbr-fonts-style display-5">JRiSpace Affiliate</h3>
                        <h4 class="card-subtitle mbr-pt-3 mbr-fonts-style mbr-bold display-7">Design &amp; Marketing Company</h4>
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">Earn up to 15% for every referral.</p>
                        <div class="card-btn mbr-section-btn mbr-pt-2"><a class="btn btn-success-outline display-7" href="https://jrispace.com/Affiliate" target="_blank">Apply Now</a></div>
                    </div>
                </div>
            </div>
            <div class="card mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-4 last-child">
                <div class="card-wrapper mbr-column">
                    <div class="card-img mbr-flex mbr-pb-3">
                        <amp-img src="https://r.8b.io/26178/images/sss2-h_k04bleg8-177x106.png" layout="responsive" width="345.6509433962264" height="207" alt="" class="placeholder-loader">
                            <div placeholder="" class="placeholder">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
                                    <circle class="big" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="230" stroke-dashoffset="230" cx="150" cy="150" r="145"></circle>
                                    <circle class="small" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="212" cx="150" cy="150" r="135"></circle>
                    ...
                    <div class="card-box mbr-m-auto align-center mbr-pt-3 mbr-px-4 mbr-pb-3">
                        ...
                        <div class="card-btn mbr-section-btn mbr-pt-2"><a class="btn btn-success-outline display-7" href="https://jristudio.8b.io/" target="_blank">Learn more</a></div>
                    </div>
                </div>
            </div>
...
<section class="header2 cid-r2LhXENyx9" id="header2-19">
...
<br>Our values are the humanistic approach, system thinking, loyalty, and confidentiality.</p>
                    <div class="mbr-section-btn mbr-pt-4"><a class="btn btn-success display-7" href="https://facebook.com/jrispace" target="_blank">Learn more</a></div>
                </div>
            </div>
            <div class="image-wrap mbr-col-md-12 mbr-col-sm-12 mbr-col-lg-6 mbr-flex">
                <div class="image-block mbr-col-md-12 mbr-col-sm-12 mbr-mr-auto">
                    <amp-img src="https://r.8b.io/26178/images/57e7d7464956ac14ea89857dc22e3-h_k8dtwgm3.jpg" layout="responsive" width="555" height="370" alt="" class="placeholder-loader">
                        <div placeholder="" class="placeholder">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
                                    <circle class="big" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="230" stroke-dashoffset="230" cx="150" cy="150" r="145"></circle>
                                    <circle class="small" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="212" cx="150" cy="150" r="135"></circle>
...
<section class="Info4 cid-r8CndDiXQd" id="info4-1y">
...
Thank you for your message.</template>
                        ...
                        <div class="fieldset">
                            <div class="field" data-for="form[data][0][1]">
                                <input type="hidden" name="form[data][0][0]" value="First Name" id="form[data][0][0]-info4-1y" data-form-field="">
                                <input type="text" name="form[data][0][1]" data-form-field="Name" placeholder="Name" required="" id="form[data][0][1]-info4-1y">
                            </div>
                            
                            <div class="field" data-for="form[data][2][1]">
                                <input type="hidden" name="form[data][1][0]" value="E-mail" id="form[data][2][0]-info4-1y" data-form-field="">
                                <input type="email" name="form[data][1][1]" data-form-field="E-mail" placeholder="E-mail Address" required="" id="form[data][2][1]-info4-1y">
                            </div>
                            
                            <div class="text-field" data-for="form[data][4][1]">
                                <input type="hidden" name="form[data][2][0]" value="Message" id="form[data][4][0]-info4-1y" data-form-field="">
                                <textarea name="form[data][2][1]" rows="5" data-form-field="Message" placeholder="Message" id="form[data][4][1]-info4-1y"></textarea>
                            </div>
                        </div>
                        <div class="mbr-section-btn"><button type="submit" class="btn btn-md btn-form btn-success display-7">Send</button></div>
                    </form>
...
<section class="pricing-table1 cid-r89yBl2fZI" id="pricing-table1-1w">
		...
		<div class="mbr-row mbr-jc-c">
			<div class="card card1 mbr-col-sm-12 mbr-col-md-6 md-pb mbr-col-lg-4 align-center">
				<div class="card-inner mbr-p-3">
					...
					<div class="card-button mbr-section-btn"><a href="/plans" class="btn btn-lg btn-success display-7" target="_blank">View More</a></div>
				</div>
			</div>
				...
				<div class="card-inner mbr-p-3">
					...
					<div class="items-list-wrap">
						...
						<li class="list-item">
								...
								<span class="item-text mbr-fonts-style display-7">5 /sites</span>
							</li><li class="list-item">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-4 align-center md-pb">
                <div class="card-wrapper mbr-flex mbr-column">
                    ...
                    <div class="card-box mbr-pt-3">
                        ...
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7"><a href="https://www.google.com/maps/dir/19.4436858,-70.6811612/JRiSpace+Virtual+Solutions,+Santiago+de+los+Caballeros+51000,+Dominican+Republic/@19.4420527,-70.6877379,15z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x8eb1cfc251de8e3d:0x15e9b8830c6be0ef!2m2!1d-70.687712!2d19.4336069" target="_blank">Santiago, Dominican Republic</a></p>
                    </div>
                </div>
            </div>
            <div class="card mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-4 align-center md-pb">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-4 align-center last-child">
                <div class="card-wrapper mbr-flex mbr-column">
                    ...
                    <div class="card-box mbr-pt-3">
                        ...
                        <p class="card-text mbr-pt-2 mbr-fonts-style display-7"><a href="mailto:contact@jrispace.net">contact@jrispace.net</a></p>
                    </div>
                </div>
            </div>
...
<section class="contacts6 map cid-r1rE47TfCJ" id="contacts6-11">
    
    
    <div class="container">
        
        <div class="map-block mbr-col-md-12 mbr-jc-c mbr-flex mbr-m-auto mbr-column">
            <div class="google-map"><amp-iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDlqUgrubRDixmu6OnRsHrqa1XpJBGnlKQ&amp;q=place_id:ChIJPY7eUcLPsY4R7-BrDIO46RU" height="400" layout="fill" sandbox="allow-scripts allow-same-origin                                 allow-popups" frameborder="0" class="placeholder-loader">
                <div placeholder="" class="placeholder">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300">
                                    <circle class="big" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="230" stroke-dashoffset="230" cx="150" cy="150" r="145"></circle>
                                    <circle class="small" fill="none" stroke="#c2e0e0" stroke-width="3" stroke-dasharray="212" cx="150" cy="150" r="135"></circle>
            ...
            <p align="center">
            <a href="https://recharge.jrispace.net" target="_blank">Recargas Rapidas</a>
            </p>
        </div>
    </div>
</section>
...
<!-- Mirrored from jritech.8b.io/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Apr 2020 21:23:03 GMT -->
</html>